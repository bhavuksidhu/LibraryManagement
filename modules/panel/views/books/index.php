            ...
            <div class="modal-body">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4 bio-row">
                            <p><span class="bold"><i class="fa fa-envelope"></i> Accession No </span><span id="v_isbn"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-4 bio-row">
                            <p><span class="bold"><i class="fa fa-envelope"></i> ISBN </span><span id="v_isbn13"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-4 bio-row">
