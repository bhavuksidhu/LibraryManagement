                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-small">
                            ...
                            <a href="<?php echo base_url(); ?>assets/csv/sample_books.csv"
                               ...
                               <span class="text-info"><?= lang('add_isbn_label'); ?>,<?= lang('add_book_label'); ?>,<?= lang('add_qty_label'); ?>,<?= lang('add_publisher_label'); ?>,<?= lang('add_digital_file_label'); ?>,<?= lang('add_isbn_13_label'); ?>,<?= lang('add_price_label'); ?>,<?= lang('add_cp_year_label'); ?>,<?= lang('add_rd_label'); ?>,<?= lang('add_desc_label'); ?>,<?= lang('categories_title'); ?>,<?= lang('authors_title'); ?>,<?= lang('add_book_pages_label');?>,<?= lang('add_bill_date_label');?>,<?= lang('add_bill_no_label');?></span>
                        </div>
