	          ...
	          <?php echo validation_errors('<div class="alert alert-error">', '</div>');?>
	    		<div class="col-md-6">
                    ...
                    <div class="digital" style="display:none;">
                     ...
                     <div class="form-group">
		              	<label class="control-label" for="book_pages"><?= lang('add_book_pages_label'); ?></label>
		          		<?php echo form_input('book_pages', set_value('book_pages',$details['book_pages']),'class="form-control" id="book_pages" '); ?>
		          	</div>
		          	
		          	<div class="form-group">
		              	<label class="control-label" for="bill_no"><?= lang('add_bill_no_label'); ?></label>
		          		<?php echo form_input('bill_no', set_value('bill_no',$details['bill_no']),'class="form-control" id="bill_no" '); ?>
		          	</div>
				...
				<div class="col-md-6">
		    		<div class="form-group">
		          	...
		          	<div class="form-group">
						...
						<input type="number" name='book_copies' id='book_copies' step="any" class="form-control" id="book_copies"  min=0 value="<?php echo (!empty($details['book_copies']) ? $details['book_copies'] : "") ?>" />

		          	</div>
		           	<div class="form-group">
		              	<label class="control-label" for="book_pub"><?= lang('edit_publisher_label'); ?></label>

						<?php echo form_input('book_pub', (!empty($details['book_pub']) ? $details['book_pub'] : ""),'class="form-control" id="book_pub" ');?>
		         	</div>
		         	<div class="form-group">
		              	<label class="control-label" for="price"><?= lang('edit_price_label'); ?></label>
						<input type="number" name='price' id='price' step="any" class="form-control" id="price"  min=0 value="<?php echo (!empty($details['price']) ? $details['price'] : "") ?>" />
		          	</div>
		           	<div class="form-group">
		              	<label class="control-label" for="copyright_year"><?= lang('edit_cp_year_label'); ?></label>

						<?php echo form_input('copyright_year', (!empty($details['copyright_year']) ? $details['copyright_year'] : ""),'class="form-control" id="copyright_year" ');?>
		          	</div>
		          	<div class="form-group">
		              	<label class="control-label" for="date_receive"><?= lang('edit_rd_label'); ?></label>

						<?php echo form_input('date_receive', (!empty($details['date_receive']) ? $details['date_receive'] : ""),'class="form-control" id="date_receive" ');?>
		          	</div>
		          	
		          	<div class="form-group">
		              	<label class="control-label" for="bill_date"><?= lang('add_bill_date_label'); ?></label>

						<?php echo form_input('bill_date', set_value('bill_date',$details['bill_date']),'class="form-control" id="bill_date" ');?>
		          	</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
...
$(document).ready(function() {
	$(".select").select2();
	$('#date_receive,#bill_date').datepicker({
      autoclose: true,
      format: 'yyyy-mm-dd'
    });
