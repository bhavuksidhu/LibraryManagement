	          ...
	          <?php echo validation_errors('<div class="alert alert-error">', '</div>');?>
	    		<div class="col-md-6">
                    ...
                    <div class="form-group">
		          		...
		          		<?php echo form_input('book_pages', set_value('book_pages'),'class="form-control" id="book_pages" '); ?>
		          	</div>
		          	
		          	<div class="form-group">
		              	<label class="control-label" for="bill_no"><?= lang('add_bill_no_label'); ?></label>
		          		<?php echo form_input('bill_no', set_value('bill_no'),'class="form-control" id="bill_no" '); ?>
		          	</div>
		    		...
		    		<div class="form-group">
		         	...
		         	<div class="form-group">
		           	...
		           	<div class="form-group">
						...
						<?php echo form_input('copyright_year', set_value('copyright_year'),'class="form-control" id="copyright_year" ');?>
		          	</div>
		          	<div class="form-group">
		              	<label class="control-label" for="date_receive"><?= lang('add_rd_label'); ?></label>

						<?php echo form_input('date_receive', set_value('date_receive'),'class="form-control" id="date_receive" ');?>
		          	</div>
		          	
		          		<div class="form-group">
		              	<label class="control-label" for="bill_date"><?= lang('add_bill_date_label'); ?></label>

						<?php echo form_input('bill_date', set_value('bill_date'),'class="form-control" id="bill_date" ');?>
		          	</div>
				</div>
				<?php 
