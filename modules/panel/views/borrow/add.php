                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                ?>
                                <input type="text" name="due_date" value="<?= ($settings->issue_conf == 1) ? date('Y-m-d', $date) : $duedate ?>"  class="form-control" id="due_date" required="required" <?= ($settings->issue_limit_days_extendable) ? '' : 'readonly' ?>/>                            
                            </div>
                        </div>
                        <div class="col-md-6">
