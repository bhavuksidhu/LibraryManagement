                ...
                <?php if (!empty($occupations)): ?>
                  ...
                  <?php foreach ($occupations as $occupation): ?>
                    <tr>
                       ...
                       <td><a href="<?= base_url();?>panel/auth/editOccuModal/<?= $occupation->class_id;?>" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                    <a href="<?= base_url(); ?>panel/auth/deleteOccuModal/<?= $occupation->class_id; ?>" type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
