          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                <thead>
                <tr>
					<th><?php echo lang('index_sname_th');?></th>
					<th><?php echo lang('index_faname_th');?></th>
					<th><?php echo lang('index_rollno_th');?></th>
				...
				<tr>
		            <td><?php echo htmlspecialchars($user->student_name,ENT_QUOTES,'UTF-8');?></td>
		            <td><?php echo htmlspecialchars($user->fathers_name,ENT_QUOTES,'UTF-8');?></td>
		            <td><?php echo htmlspecialchars($user->roll_no,ENT_QUOTES,'UTF-8');?></td>
