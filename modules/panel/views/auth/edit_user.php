...
<?php echo form_open_multipart(uri_string());?>
      ...
      <p>
            <?php echo lang('edit_user_sname_label', 'student_name');?> <br />
            <?php echo form_input($student_name, '', 'class="form-control"');?>
      </p>

      <p>
            <?php echo lang('edit_user_faname_label', 'fathers_name');?> <br />
            <?php echo form_input($fathers_name, '', 'class="form-control"');?>
      </p>

      <p>
            <?php echo lang('edit_user_rollno_label', 'roll_no');?> <br />
